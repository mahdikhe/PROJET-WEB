...
try {
    ...
    $emailContent .= "
        ...
        <p><a href='{$inviteUrl}' style='display:inline-block;padding:10px 20px;background-color:#4361ee;color:#ffffff;text-decoration:none;border-radius:5px;'>Rejoindre la tache</a></p>
    ...
    try {
        ...
        $mail->Password   = 'ezee jqsi spgw naws';      // App password from Google
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;
        $mail->CharSet    = 'UTF-8';
