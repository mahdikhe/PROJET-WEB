...
if (isset($_POST['id']) && !empty($_POST['id'])) {
    ...
    try {
        ...
        $updateStmt = $pdo->prepare("UPDATE entretiens SET status = 'rejected' WHERE id = :id");
        ...
        $emailSent = $emailSender->sendRejectionEmail($recipientEmail, $recipientName, $jobDetails);
