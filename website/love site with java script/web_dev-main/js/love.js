(function(window) {
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        ...
        // Replace random color generation with only green and blue
        if (!color) {
            // Choose between blue and green
            var colors = ['rgb(0, 0, 255)', 'rgb(0, 255, 0)']; // Blue, Green
            this.color = colors[random(0, 1)]; // Randomly select between index 0 and 1
        } else {
            this.color = color;
        }
