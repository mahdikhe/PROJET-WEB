    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="../projet/create project/edit-project.php?id=<?= $project['id'] ?>" class="btn btn-primary">
        ...
        <div class="project-card">
            <div class="project-header">
                ...
                <img src="<?= htmlspecialchars('../projet/create project/' . $project['projectImage']) ?>" alt="<?= htmlspecialchars($project['projectName']) ?>" class="project-image">
                <?php else: ?>
                <div class="project-image" style="display: flex; align-items: center; justify-content: center; background-color: #f5f5f5;">
