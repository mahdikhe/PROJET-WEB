...
function getRandomWord() {
    ...
    words = `Les défis urbains d’aujourd’hui ne se relèveront pas seuls. Votre voix, vos idées, vos projets sont essentiels. Créez. Collaborez. Transformez votre quartier, votre ville, votre quotidien. Ne restez pas spectateur. Devenez acteur du changement. <a href="../projet/project.html#consultation" style="color:#007BFF;text-decoration:underline;">Donnez vie à votre idée dès maintenant !</a>`;
